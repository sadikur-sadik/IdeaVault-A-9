...
const IdeaCard = ({ idea }) => {
  ...
  return (
    <div className=" mx-auto hover:shadow-lg dark:bg-linear-to-b dark:from-slate-800 dark:via-slate-900 dark:to-slate-900 bg-white border-t-15 border-t-cyan-400 w-5/6 md:w-auto rounded-3xl p-3 shadow-sm shadow-cyan-400">
      ...
      <div className="my-3">
        <Link href={`ideas/${_id}`}><button className="hover:bg-cyan-400 hover:text-white font-bold px-3 py-2 w-full rounded-full  text-cyan-400 bg-transparent border border-cyan-400">View Details</button></Link>
      </div>
    </div>
  );
};
