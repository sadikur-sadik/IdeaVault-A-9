    ...
    <div className="relative text-slate-300 dark:text-slate-600 bg-slate-950 dark:bg-white w-full shadow-md border-b border-slate-950/50 dark:border-slate-200 transition-colors duration-200">
      ...
      <div className="container mx-auto z-50 relative py-3 px-4 flex justify-between items-center h-16">
        <div className="flex items-center gap-2 lg:min-w-45">
          <label
            htmlFor="navbar-1-toggle"
            className="btn btn-ghost lg:hidden text-cyan-400 dark:text-cyan-600 hover:bg-slate-900 dark:hover:bg-slate-100 mr-1 cursor-pointer"
          >
          ...
          <Link href="/" className="text-2xl normal-case hover:bg-slate-900 dark:hover:bg-slate-100 px-3 py-1.5 rounded-md transition-all duration-200 flex items-center tracking-tight shrink-0">
      ...
      <div className="absolute top-full left-0 w-full bg-slate-950 dark:bg-white rounded-b-md shadow-lg hidden peer-checked:max-lg:block z-50 border-t border-slate-900 dark:border-slate-100">
        <ul className="menu menu-vertical p-4 gap-1 text-slate-300 dark:text-slate-600 font-medium">
          <li>
            <Link href="/" className={`block px-3 py-2 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 hover:text-cyan-400 dark:hover:text-cyan-600 ${path === "/" ? "bg-slate-900 dark:bg-slate-100 border-l-4 border-cyan-400 dark:border-cyan-600 font-bold text-cyan-400 dark:text-cyan-600" : ""}`}>
              Home
            </Link>
          </li>
          <li>
            <Link href="/ideas" className={`block px-3 py-2 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 hover:text-cyan-400 dark:hover:text-cyan-600 ${path === "/ideas" ? "bg-slate-900 dark:bg-slate-100 border-l-4 border-cyan-400 dark:border-cyan-600 font-bold text-cyan-400 dark:text-cyan-600" : ""}`}>
              Ideas
            </Link>
          </li>
          <li>
            <Link href="/add-ideas" className={`block px-3 py-2 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 hover:text-cyan-400 dark:hover:text-cyan-600 ${path === "/add-ideas" ? "bg-slate-900 dark:bg-slate-100 border-l-4 border-cyan-400 dark:border-cyan-600 font-bold text-cyan-400 dark:text-cyan-600" : ""}`}>
              Add Ideas
            </Link>
          </li>
          <li>
            <Link href="/my-ideas" className={`block px-3 py-2 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 hover:text-cyan-400 dark:hover:text-cyan-600 ${path === "/my-ideas" ? "bg-slate-900 dark:bg-slate-100 border-l-4 border-cyan-400 dark:border-cyan-600 font-bold text-cyan-400 dark:text-cyan-600" : ""}`}>
              My Ideas
            </Link>
          </li>
          <li>
            <Link href="/my-interactions" className={`block px-3 py-2 rounded-md hover:bg-slate-800 dark:hover:bg-slate-100 hover:text-cyan-400 dark:hover:text-cyan-600 ${path === "/my-interactions" ? "bg-slate-900 dark:bg-slate-100 border-l-4 border-cyan-400 dark:border-cyan-600 font-bold text-cyan-400 dark:text-cyan-600" : ""}`}>
              My Interactions
            </Link>
          </li>
        </ul>
